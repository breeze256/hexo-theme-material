...
var componentHandler = (function () {
  ...
  function i(t, s) {
    if (void 0 === t && void 0 === s)
      ...
      for (var o = document.querySelectorAll("." + s), d = 0; d < o.length; d++)
        n(o[d], l);
    }
  }
    ...
    for (var t, s = 0, i = e.length; i > s; s++)
      (t = e[s]),
        t instanceof HTMLElement &&
          (t.children.length > 0 && a(t.children), n(t));
  }
...
window.addEventListener("load", function () {
  ...
  Array.prototype.forEach
    ...
    : (componentHandler.upgradeElement = componentHandler.register =
        function () {});
}),
  (function () {
    "use strict";
  ...
  (MaterialTooltip.prototype.handleMouseLeave_ = function (e) {
    ...
    e.stopPropagation(),
      ...
      window.removeEventListener("touchmove", this.boundMouseLeaveHandler, !1);
  }),
  (MaterialTooltip.prototype.init = function () {
    ...
    if (this.element_) {
      ...
      e && (this.forElement_ = document.getElementById(e)),
        this.forElement_ &&
          (this.forElement_.getAttribute("tabindex") ||
  ...
  (MaterialLayout.prototype.init = function () {
    ...
    if (this.element_) {
      ...
      if (
        ...
        a.classList.add(this.CssClasses_.DRAWER_BTN),
          this.drawer_.classList.contains(this.CssClasses_.ON_LARGE_SCREEN)
            ? a.classList.add(this.CssClasses_.ON_LARGE_SCREEN)
            : this.drawer_.classList.contains(
                this.CssClasses_.ON_SMALL_SCREEN,
              ) && a.classList.add(this.CssClasses_.ON_SMALL_SCREEN);
      ...
      if (this.header_ && this.tabBar_) {
        ...
        d.classList.add(this.CssClasses_.TAB_BAR_BUTTON),
          d.classList.add(this.CssClasses_.TAB_BAR_LEFT_BUTTON);
        var _ = document.createElement("i");
        _.classList.add(this.CssClasses_.ICON),
          (_.textContent = this.Constant_.CHEVRON_LEFT),
          d.appendChild(_),
          d.addEventListener(
            "click",
            function () {
        ...
        var u = function () {
          this.tabBar_.scrollLeft > 0
            ? d.classList.add(this.CssClasses_.IS_ACTIVE)
            : d.classList.remove(this.CssClasses_.IS_ACTIVE),
        ...
        for (
          ...
          new MaterialLayoutTab(p[E], p, C, this);
      }
      this.element_.classList.add(this.CssClasses_.IS_UPGRADED);
    }
  }),
