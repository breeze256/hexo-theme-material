(function () {
  ...
  html +=
    '                <div class="ib-browser-description">由苹果公司设计用于 Mac 的产品</div>';
  html += "            </a>";
  html += "        </li>";
  html += "        <li>";
  ...
  html +=
    '                <div class="ib-browser-description">快速, 小巧的浏览器</div>';
  html += "            </a>";
  html += "        </li>";
  html += "    </ul>";
  html += '    <div class="ib-footer">';
  html +=
    '        <a class="ib-try" href="http://www.google.cn/chrome/browser/desktop/index.html">试试Chrome</a>';
  html += "    </div>";
  html += "</div>";
